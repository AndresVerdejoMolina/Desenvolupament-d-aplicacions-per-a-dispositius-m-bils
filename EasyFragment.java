...
public class EasyFragment extends Fragment {
    ...
    public static EasyFragment newInstance(String param1, int color) {
    ...
    public void onAttach(Context context) {
        ...
        if(context instanceof  fraguno){
            mListener=(fraguno) context;
        }else{
            throw new RuntimeException(context.toString()
                    + " must implement OnFragmentInteractionListener");
        }
    }
    public interface fraguno{
        void pulsado(String par);
    }
    public interface fraguno2{
        void pulsado(String par);
    }
}
